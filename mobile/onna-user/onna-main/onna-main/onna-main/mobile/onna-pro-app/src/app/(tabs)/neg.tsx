            ...
            <View className=" ">
                ...
                <View className=" mt-10 w-[385px] h-[18.75%] bg-white flex-column justify-center items-center rounded-[15px] gap-4 shadow-black shadow-2xl" >
                    <Text className="color-black text-[18.75px] font-Imedium text-center">
                        Com base nas suas respostas, <Text className="color-red-900 font-Imedium text-center text-[20.75px] font-bold " >você não está grávida</Text>, é possível que haja alguma alteração no seu ciclo menstrual.
                    </Text>
                </View>
